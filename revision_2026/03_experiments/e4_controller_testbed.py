"""E4 / E7 / E8 - Controller-in-the-loop OpenFlow testbed (R4.2, R3.3, R3.4, R2.1).

Reviewer 4 asks for a live proof of concept with controller CPU and memory,
end-to-end detection latency and QoS impact. Reviewer 3 asks how 60,000 novel
