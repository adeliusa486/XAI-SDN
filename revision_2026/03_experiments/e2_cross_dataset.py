"""E2 - Cross-dataset validation with confidence intervals (R4.1, R2.1, R6.1, R7.4).

Reviewer 4 asks for cross-dataset validation on InSDN and CIC-IDS2017/2018 with
FPR/FNR confidence intervals. Reviewer 6 demands validation beyond CIC-DDoS2019.
Reviewer 2 says the generalization claims are not licensed by the evidence.
