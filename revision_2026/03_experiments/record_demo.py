"""Record the Mininet live demonstration as a video (R4.2).

Reviewer 4 asked for a live proof of concept. A paper cannot show one, but
...
def main() -> int:
    ...
    # Stills of each stage, for the figure in the paper and for the reviewer who
