"""E3 - Cross-vector and cross-day generalization (R6.1, R7.4, R2.1).

Reviewer 6 calls SYN-only evaluation "methodologically bankrupt"; Reviewer 7
says it "provides limited evidence of generalization"; Reviewer 2 says the
