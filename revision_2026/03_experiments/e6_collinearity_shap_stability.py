"""E6 - Collinearity, redundancy and SHAP attribution stability (R3.2, R6.6, R6.8).

Reviewer 3 asks what collinearity diagnostics were applied to make the SHAP
attributions "causally stable and operationally trustworthy". Reviewer 6 says
the 88-dimensional input ignores severe multicollinearity. Reviewer 6 further
