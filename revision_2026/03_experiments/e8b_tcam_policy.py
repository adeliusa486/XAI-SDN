"""E8b - flow-table occupancy under six aggregation policies (R3.4).

Reviewer 3 asks what flow-rule aggregation and eviction prevent TCAM overflow
...
before any policy result can be read. Reviewer 3's premise is that a spoofed
...
def main() -> int:
    ...
    out["interpretation"] = (
        ...
        "mode Reviewer 3 identifies, but on this corpus it overflows through the "
