"""E5b - Duplicate-driven leakage across the split boundary (R4.1, R6.1, R6.8).

Reviewer 4 asks for a "duplicate/near-duplicate flow analysis". Running that on
...
measures the straddle rate under both candidate protocols:
  ...
  * the temporal split the manuscript described and the revision adopts.
