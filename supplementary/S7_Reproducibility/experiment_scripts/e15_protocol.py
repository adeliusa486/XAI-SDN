"""E15 - Evaluation protocol formalisation.

This experiment does not merely document the splitting, cross-validation and
tuning/testing separation, it executes them, so the manuscript can report
measured fold-level variance rather than an assurance.
