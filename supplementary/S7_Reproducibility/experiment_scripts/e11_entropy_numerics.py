"""E11 - Numerical stability of the rolling entropy engine.

An incremental entropy update adds and subtracts terms of comparable
magnitude, so catastrophic cancellation and floating-point drift are a
legitimate concern for a detector intended to run continuously. This
experiment measures the drift rather than arguing about it.

Two facts frame the study:
