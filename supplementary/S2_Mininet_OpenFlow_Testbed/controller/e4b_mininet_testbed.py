"""E4b - Mininet proof of concept with live traffic.

This experiment provides "a Mininet/Ryu or ONOS proof-of-concept with live traffic,
...
def run_condition(tag: str, env: dict, attack_s: int) -> dict:
    ...
    # Verbatim terminal evidence for the paper. This experiment provides a live
