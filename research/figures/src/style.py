...
Only the type sizes differ from the original generators. The colours, hatching,
spines, grid, legend frames and line weights here are copied verbatim from them
...
# This experiment provides larger type. 1.35 was not enough: measured in the
