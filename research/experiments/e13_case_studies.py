...
A global attribution ranking does not show what an operator receives when a
single alert arrives. Four real cases are drawn from actual test predictions - never constructed -
